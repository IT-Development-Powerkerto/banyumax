    ...
    public function index(Request $request)
    {
        ...
        if($day >= $user_expired){
            ...
            if(Auth::user()->role_id == 2){
                return view('ceo.CEO', compact('leads','day', 'announcements','lead_max','lead_day', 'lead_week', 'lead_month', 'lead_all', 'products', 'omset_day', 'omset_week', 'omset_month', 'omset_all', 'budgeting_day', 'budgeting_week', 'budgeting_month', 'budgeting_all', 'closing_max','lead_count','closing_count', 'quantity', 'user_count', 'lead_su', 'lead_mo', 'lead_tu', 'lead_we', 'lead_th', 'lead_fr','lead_sa', 'closing_su', 'closing_mo', 'closing_tu','closing_we','closing_th','closing_fr','closing_sa','adv','omset1', 'omset2', 'omset3', 'omset4', 'omset_permonth','budgeting','budgeting_adv','budgeting_nonadv','budgeting_realization_adv','budgeting_realization_nonadv', 'omset_su', 'omset_mo', 'omset_tu', 'omset_we', 'omset_th','omset_fr','omset_sa','advertising_su', 'advertising_mo', 'advertising_tu','advertising_we','advertising_th','advertising_fr','advertising_sa','lead_day_count','omset_day_count','advertising_day_count','evaluation'));
            }elseif(Auth::user()->role_id == 1){
                return view('ceo.Dashboard', compact('leads','day', 'announcements','lead_max','lead_day', 'lead_week', 'lead_month', 'lead_all', 'products', 'omset_day', 'omset_week', 'omset_month', 'omset_all', 'budgeting_day', 'budgeting_week', 'budgeting_month', 'budgeting_all', 'closing_max','lead_count','closing_count', 'quantity', 'user_count', 'lead_su', 'lead_mo', 'lead_tu', 'lead_we', 'lead_th', 'lead_fr','lead_sa', 'closing_su', 'closing_mo', 'closing_tu','closing_we','closing_th','closing_fr','closing_sa','adv','omset1', 'omset2', 'omset3', 'omset4', 'omset_permonth','budgeting','budgeting_adv','budgeting_nonadv','budgeting_realization_adv','budgeting_realization_nonadv', 'omset_su', 'omset_mo', 'omset_tu', 'omset_we', 'omset_th','omset_fr','omset_sa','advertising_su', 'advertising_mo', 'advertising_tu','advertising_we','advertising_th','advertising_fr','advertising_sa','lead_day_count','omset_day_count','advertising_day_count','evaluation'));
            }else {
