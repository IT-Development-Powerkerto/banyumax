	...
	<div class="card-body p-0">
		...
		<div class="px-9 pt-7 card-rounded h-275px w-100 bg-danger">
			...
			<div class="d-flex flex-stack">
				<h3 class="m-0 text-white fw-bolder fs-3">Leave Application</h3>
			</div>
			<!--end::Heading-->
			<!--begin::Balance-->
			<div class="d-flex text-center flex-column text-white pt-8">
				<span class="fw-bold fs-7">Application</span>
				<span class="fw-bolder fs-2x pt-1">12</span>
			</div>
			<!--end::Balance-->
		</div>
		<!--end::Header-->
		...
		<div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1 scroll scroll-pull" data-scroll="true" data-wheel-propagation="true" style="height: 280px; margin-top: -100px">
			...
			<div class="d-flex align-items-center mb-6">
				...
				<div class="symbol symbol-45px w-40px me-5">
					<span class="symbol-label bg-lighten">
						...
						<i class="las la-user-edit" style="font-size:24px"></i>
						<!--end::Svg Icon-->
					</span>
				</div>
				<!--end::Symbol-->
				...
				<div class="d-flex align-items-center flex-wrap w-100">
					...
					<div class="mb-1 pe-3 flex-grow-1">
						<label class="fs-5 text-gray-800 text-hover-primary fw-bolder">Advertise</label>
					</div>
					<!--end::Title-->
					<!--begin::Label-->
			...
			<div class="d-flex align-items-center mb-6">
				...
				<div class="symbol symbol-45px w-40px me-5">
					<span class="symbol-label bg-lighten">
						<!--begin::Svg Icon | path: icons/duotune/electronics/elc005.svg-->
						<i class="las la-pen-nib" style="font-size: 24px"></i>
						<!--end::Svg Icon-->
					</span>
				</div>
				<!--end::Symbol-->
				...
				<div class="d-flex align-items-center flex-wrap w-100">
					<!--begin::Title-->
					<div class="mb-1 pe-3 flex-grow-1">
						<label class="fs-5 text-gray-800 text-hover-primary fw-bolder">DGM</label>
					</div>
					<!--end::Title-->
					<!--begin::Label-->
					<div class="d-flex align-items-center">
			...
			<div class="d-flex align-items-center mb-6">
				...
				<div class="symbol symbol-45px w-40px me-5">
					<span class="symbol-label bg-lighten">
						<!--begin::Svg Icon | path: icons/duotune/electronics/elc005.svg-->
						<i class="lab la-wordpress" style="font-size: 24px"></i>
						<!--end::Svg Icon-->
					</span>
				</div>
				<!--end::Symbol-->
				...
				<div class="d-flex align-items-center flex-wrap w-100">
					<!--begin::Title-->
					<div class="mb-1 pe-3 flex-grow-1">
						<label class="fs-5 text-gray-800 text-hover-primary fw-bolder">CWM</label>
					</div>
					<!--end::Title-->
					<!--begin::Label-->
					<div class="d-flex align-items-center">
			...
			<div class="d-flex align-items-center">
				...
				<div class="d-flex align-items-center flex-wrap w-100">
					...
					<!--begin::Label-->
					<div class="d-flex align-items-center">
						<div class="fw-bolder fs-5 text-gray-800 pe-1">3</div>
					</div>
					<!--end::Label-->
				</div>
				<!--end::Description-->
