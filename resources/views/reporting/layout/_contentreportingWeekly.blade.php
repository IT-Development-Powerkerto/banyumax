		...
		<div class="col-xl-12">
			...
			<div class="row g-xl-12">
				...
				<div class="col-xl-3">
					...
					@include('partials/widgets/reporting/Weekly/_widget-10')
		
				</div>
				<div class="col-xl-3">

					@include('partials/widgets/reporting/Weekly/_widget-11')
		
				</div>
				<div class="col-xl-3">

					@include('partials/widgets/reporting/Weekly/_widget-12')
		
				</div>
				<div class="col-xl-3">

					@include('partials/widgets/reporting/Weekly/_widget-13')
